...
// G-Buffer Textures
Texture2D txPosition_G : register(t20);
Texture2D txNormal_G : register(t21);
Texture2D txAlbedo_G : register(t22);
Texture2D txMR_G : register(t23);
Texture2D txEmissive_G : register(t24);
